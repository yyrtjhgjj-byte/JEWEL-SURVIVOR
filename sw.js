...
const CACHE = 'jewel-survivor-v49';
const ASSETS = [
  ...
  './js/stages.js', './js/enemies.js', './js/hazards.js', './js/atelier.js', './js/atelier-ui.js', './js/artifacts.js', './js/artifact-art.js', './js/shop-art.js', './js/gem-facts.js', './js/elements.js', './js/rank.js', './js/howto.js',
