...
export const ENEMIES = {
  ...
  boss1: { name: 'ダスク・キング', hp: 30000, speed: 50, dmg: 20, r: 48, xp: 200, boss: true, color: '#5b3f8a', desc: '粘体の王。2:06に出現。全方位弾と眷属召喚。' },
  boss2: { name: 'ヴォイド・ドラゴン', hp: 90000, speed: 62, dmg: 26, r: 52, xp: 500, boss: true, color: '#2e1f4f', desc: '夜空を塗り潰す竜。4:12に出現。螺旋弾と突進。' },
  ...
  // ---- ステージ別の中ボス
  boss1_cavern: { name: 'クリスタル・キング', hp: 36000, speed: 50, dmg: 20, r: 48, xp: 200, boss: true, ai: 'boss1', sprite: 'boss1', tint: '#2f7fb0', desc: '水晶洞窟の粘体王。2:06に出現。' },
  boss2_cavern: { name: 'ジェム・ドラゴン', hp: 100000, speed: 62, dmg: 26, r: 52, xp: 500, boss: true, ai: 'boss2', sprite: 'boss2', tint: '#1f4f8a', desc: '宝石を喰らって育った竜。4:12に出現。' },
  boss1_magma: { name: 'ブレイズ・キング', hp: 36000, speed: 52, dmg: 22, r: 48, xp: 200, boss: true, ai: 'boss1', sprite: 'boss1', tint: '#b8401f', desc: '溶岩をまとう粘体王。2:06に出現。' },
  boss2_magma: { name: 'インフェルノ・ドラゴン', hp: 100000, speed: 64, dmg: 28, r: 52, xp: 500, boss: true, ai: 'boss2', sprite: 'boss2', tint: '#8a1f1f', desc: '灼熱の吐息を放つ竜。4:12に出現。' },
  boss1_tundra: { name: 'グレイシャー・キング', hp: 36000, speed: 48, dmg: 22, r: 48, xp: 200, boss: true, ai: 'boss1', sprite: 'boss1', tint: '#7fa8d0', desc: '氷河を背負う粘体王。2:06に出現。' },
  boss3_tundra: { name: 'スノウ・クイーン', hp: 120000, speed: 56, dmg: 28, r: 58, xp: 800, boss: true, ai: 'boss3', sprite: 'boss3', tint: '#3a5a8a', desc: '氷原を統べる女王。4:12に出現。' },
  boss1_void: { name: 'ヴォイド・キング', hp: 40000, speed: 52, dmg: 24, r: 48, xp: 200, boss: true, ai: 'boss1', sprite: 'boss1', tint: '#3a1a5a', desc: '虚空の粘体王。2:06に出現。' },
  boss3_void: { name: 'クイーン・シャドウ', hp: 150000, speed: 58, dmg: 30, r: 58, xp: 800, boss: true, ai: 'boss3', sprite: 'boss3', tint: '#2a0a3a', desc: '女王の残影。虚空聖堂の6:18に出現。' },
  // ---- 最終ボス
  ...
  emperor: { name: 'ヴォイド・エンペラー', hp: 300000, speed: 50, dmg: 34, r: 66, xp: 4000, boss: true, ai: 'emperor', desc: 'ダスクを生み出した虚空の皇帝。3つの形態を持つ。8:24に出現。' },
...
export const ACHIEVEMENTS = [
  ...
  { id: 'solo', name: 'ミニマリスト', t: '武器2つ以下でステージをクリア', coins: 1500, check: (r) => r.cleared && r.weaponCount <= 2 },
