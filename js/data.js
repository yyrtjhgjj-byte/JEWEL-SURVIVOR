// =====================================================================
//  ジュエルのデータ
//  宝石言葉（ジュエルパワー）は、サンリオ×セガトイズ『ジュエルペット』の
...
export const WEAPONS = {
  ruby: {
    ...
    levels: [
      ...
      { dmg: 40, t: 'ダメージ +40' },
      { cd: -0.15, t: '連射速度アップ' },
      { amount: 1, dmg: 50, pierce: 1, t: '弾数 +1 / ダメージ +50 / 貫通 +1' },
    ],
    evo: {
  ...
  sapphire: {
    ...
    levels: [
      { amount: 1, t: 'オーブ +1' },
      { dmg: 20, speed: 0.3, t: 'ダメージ +20 / 回転速度アップ' },
  ...
  garnet: {
    ...
    levels: [
      ...
      { amount: 1, t: '投擲数 +1' },
      { dmg: 50, cd: -0.15, t: 'ダメージ +50 / 投擲速度アップ' },
      { pierce: 3, t: '貫通 +3' },
      { amount: 1, dmg: 60, t: '投擲数 +1 / ダメージ +60' },
    ],
  ...
  labradorite: {
    ...
    levels: [
      ...
      { dmg: 60, t: 'ダメージ +60' },
      { amount: 1, t: '落雷数 +1' },
      { dmg: 80, area: 0.25, cd: -0.2, t: 'ダメージ +80 / 範囲 / クールダウン' },
    ],
  ...
  amber: {
    ...
    levels: [
      ...
      { dmg: 40, t: 'ダメージ +40' },
      { amount: 1, t: '金貨 +1' },
      { dmg: 50, area: 0.2, t: 'ダメージ +50 / 範囲アップ' },
    ],
  ...
  diamond: {
    ...
    levels: [
      ...
      { pierce: 1, t: '貫通 +1' },
      { amount: 2, t: '破片 +2' },
      { dmg: 25, cd: -0.15, t: 'ダメージ +25 / クールダウン短縮' },
      { life: 0.2, t: '射程アップ' },
      { amount: 4, dmg: 30, t: '破片 +4 / ダメージ +30' },
    ],
  ...
  emerald: {
    ...
    levels: [
      ...
      { dmg: 12, cd: -0.3, t: 'ダメージ +12 / クールダウン短縮' },
      { area: 0.2, t: '範囲アップ' },
      { amount: 1, dmg: 15, t: 'フィールド +1 / ダメージ +15' },
    ],
  ...
  kyanite: {
    ...
    evo: { with: 'prase', name: 'ディサイシブ・ブレード', desc: '命中時に6本へ分裂する' },
  },
  aquamarine: {
...
export const PASSIVES = {
  ...
  nephrite: { gem: 'nephrite', name: 'ネフライト', max: 2, per: { amount: 1 }, t: '弾数 +1' },
